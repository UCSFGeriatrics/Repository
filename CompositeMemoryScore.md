...
Last Edited: 2022-05-22

This program derive Composite memory score and Dementia probabilities variables following Wu et al., 2002 methodology
Updated program to include 2018 variables. I used HRS Cognition Imputations 1992-2018 (data: cogimp9218a_r) instead of RAND HRS to get variables for direct assessments 
...
The code is indicated below but you may also download it ([here](https://github.com/UCSFGeriatrics/Repository/blob/master/cogvars_gdr_20220522.sas)).

_______________________________________________________________________________________________________________

```

/*********** Date completed: 2022.05.22 ***********/
**********************************************************************************************************************************;
*Statistician: Grisell Diaz-Ramirez                                                                                               ;
*Purpose:  Create dataset with cognitive variables dementia predicted probability and composite memory score for waves 1995-2018  ;
*          using Maria Glymour paper: Wu et. al, 2012                                                                             ;
...
*Input datasets: cogimp9218a_r: HRS Cognition Imputations 1992-2018, Version 7.0, April 2022                                      ;
*                randhrs1992_2018v1: RAND HRS Longitudinal File 2018 (V1), February 2021                                          ;
*                trk2018tr_r: 2018 Tracker Final, Version 1.0 April 2022                                                          ;
*                RAND Fat files: 1992-2018                                                                                        ;
*Output datasets: cogvars_gdr_20220522, cogvarsred_gdr_20220522                                                                   ;
...
data cog.randvars;
 set rand.randhrs1992_2018v1 (keep=HHIDPN HACOHORT RACOHBYR
   		 				  R1IWSTAT R2IWSTAT R3IWSTAT R4IWSTAT R5IWSTAT R6IWSTAT R7IWSTAT R8IWSTAT R9IWSTAT R10IWSTAT R11IWSTAT R12IWSTAT R13IWSTAT R14IWSTAT
						 /*This variable gives the response and mortality status of the Respondent at each wave. Respondents are identified
						  ...
						  R1WTRESP R2WTRESP R3WTRESP R4WTRESP R5WTRESP R6WTRESP R7WTRESP R8WTRESP R9WTRESP R10WTRESP R11WTRESP R12WTRESP R13WTRESP /*Person-Level Analysis Weight*/
		   				  R1PROXY  R2PROXY  R3PROXY  R4PROXY  R5PROXY  R6PROXY  R7PROXY  R8PROXY  R9PROXY  R10PROXY  R11PROXY R12PROXY R13PROXY R14PROXY /*Whether Proxy Interview. 0.not proxy, 1.proxy: interview is by proxy in wave*/
						  );
proc sort; by hhidpn; run; /*42233 observations and 44 variables.*/

proc contents data= hrscog.cogimp9218a_r; run;

/*Get all the direct assessment variables from cogimp9218a_r*/
data directvars;
	set hrscog.cogimp9218a_r 
   (keep=HHID PN
		/*Immediate word recall.They are counts of the number of words from a 10 word list that were recalled correctly.
		  In waves 1 and 2H, the word list contained 20 nouns instead of 10 as in other waves. That's why I don't include wave 1 and 2H variables*/
		   R2AIMRC10 R3IMRC R4IMRC R5IMRC R6IMRC R7IMRC R8IMRC R9IMRC R10IMRC R11IMRC R12IMRC R13IMRC R14IMRC
		   ...
		   R2FIMRC R3FIMRC R4FIMRC R5FIMRC R6FIMRC R7FIMRC R8FIMRC R9FIMRC R10FIMRC R11FIMRC R12FIMRC R13FIMRC R14FIMRC
		...
		/*Delayed Word Recall. They are counts of the number of words from the 10 word immediate recall list that were recalled correctly after a delay of
		 ...
		 That's why I don't include wave 1 and 2H variables*/
		   R2ADLRC10 R3DLRC R4DLRC R5DLRC R6DLRC R7DLRC R8DLRC R9DLRC R10DLRC R11DLRC R12DLRC R13DLRC R14DLRC
		   ...
		   R2FDLRC R3FDLRC R4FDLRC R5FDLRC R6FDLRC R7FDLRC R8FDLRC R9FDLRC R10FDLRC R11FDLRC R12FDLRC R13FDLRC R14FDLRC
 		...
 		/*To create new TICS variable excluding 'naming scissors' and 'second attempt at counting backward from 20. I need the following variables
          ...
          /*Serial 7’s: provides the number of correct subtractions in the serial 7s test. This test asks the individual to subtract
            ...
            R2SER7 R3SER7 R4SER7 R5SER7 R6SER7 R7SER7 R8SER7 R9SER7 R10SER7 R11SER7 R12SER7 R13SER7 R14SER7
		  ...
		  /*Object Naming: whether the Respondent was able to correctly name a cactus based on a verbal description. 
            ...
            R2CACT R3CACT R4CACT R5CACT R6CACT R7CACT R8CACT R9CACT R10CACT R11CACT R12CACT R13CACT R14CACT
		  ...
		  /*Date Naming: whether the Respondent was able to report today’s date correctly, including the day of month, month, year, and day of week*/
			R2DY R3DY R4DY R5DY R6DY R7DY R8DY R9DY R10DY R11DY R12DY R13DY R14DY /*Cognition Date naming-Day of the Month*/
			R2MO R3MO R4MO R5MO R6MO R7MO R8MO R9MO R10MO R11MO R12MO R13MO R14MO /*Cognition Date naming-Month*/
			R2YR R3YR R4YR R5YR R6YR R7YR R8YR R9YR R10YR R11YR R12YR R13YR R14YR /*Cognition Date naming-Year*/
			R2DW R3DW R4DW R5DW R6DW R7DW R8DW R9DW R10DW R11DW R12DW R13DW R14DW /*Cognition Date naming-Day of week*/

		  /*President/Vice-President Naming*/
			R2PRES R3PRES R4PRES R5PRES R6PRES R7PRES R8PRES R9PRES R10PRES R11PRES R12PRES R13PRES R14PRES
			R2VP R3VP R4VP R5VP R6VP R7VP R8VP R9VP R10VP R11VP R12VP R13VP R14VP
		  ...
		  /*Backwards Counting: indicate whether the Respondent was able to successfully count backwards for 10 continuous numbers from 20
			...
			R2BWC20 R3BWC20 R4BWC20 R5BWC20 R6BWC20 R7BWC20 R8BWC20 R9BWC20 R10BWC20 R11BWC20 R12BWC20 R13BWC20 R14BWC20
		   ...
		   R2ACOGTOT R3COGTOT R4COGTOT R5COGTOT R6COGTOT R7COGTOT R8COGTOT R9COGTOT R10COGTOT R11COGTOT R12COGTOT R13COGTOT R14COGTOT);
		   ...
		   /*In Wu et al., 2012 paper they omitted the second attemp at counting backward from 20 so we need to recode the RAND variables: RwBWC20
			...
			2.Correct, 1st try*/
		  array count[13] R2BWC20 R3BWC20 R4BWC20 R5BWC20 R6BWC20 R7BWC20 R8BWC20 R9BWC20 R10BWC20 R11BWC20 R12BWC20 R13BWC20 R14BWC20; /*0-2*/
		  array newcount[13] R2BWC20new R3BWC20new R4BWC20new R5BWC20new R6BWC20new R7BWC20new R8BWC20new R9BWC20new R10BWC20new R11BWC20new R12BWC20new R13BWC20new R14BWC20new; /*0-1*/
		  ...
		  TICSe06=0;TICSp06ms=0; TICSe08=0;TICSp08ms=0; TICSe10=0;TICSp10ms=0; TICSe12=0;TICSp12ms=0; TICSe14=0;TICSp14ms=0; TICSe16=0;TICSp16ms=0; TICSe18=0;TICSp18ms=0;
		  ...
		  array tice[13]  TICSe93   TICSe95    TICSe98     TICSe00    TICSe02    TICSe04    TICSe06    TICSe08    TICSe10    TICSe12 	TICSe14 	TICSe16		TICSe18; /*sum of all tics questions excluding serial 7s, range: 0-8*/
		  array ticm[13]  TICSp93ms TICSp95ms  TICSp98ms   TICSp00ms  TICSp02ms  TICSp04ms  TICSp06ms  TICSp08ms  TICSp10ms  TICSp12ms 	TICSp14ms	TICSp16ms	TICSp18ms; /*number of missing questions*/
		  array ser7[13]  R2SER7    R3SER7     R4SER7      R5SER7     R6SER7     R7SER7     R8SER7     R9SER7     R10SER7    R11SER7 	R12SER7		R13SER7		R14SER7;
		  array tics[13]  tics2     tics3      tics4       tics5      tics6      tics7      tics8      tics9      tics10     tics11 	tics12		tics13		tics14; /*sum of all tics questions including serial 7s, range: 0-13*/
...
/*40868 observations and 237*/

/*QC*/
proc freq data=directvars; tables R2BWC20new R3BWC20new R4BWC20new R5BWC20new R6BWC20new R7BWC20new R8BWC20new R9BWC20new R10BWC20new R11BWC20new R12BWC20new R13BWC20new R14BWC20new; run;
proc freq data=directvars; tables TICSe93   TICSe95    TICSe98     TICSe00    TICSe02    TICSe04    TICSe06    TICSe08    TICSe10    TICSe12 TICSe14 TICSe16 TICSe18; run; /*as expected range 0-8*/
proc freq data=directvars; tables TICSp93ms TICSp95ms  TICSp98ms   TICSp00ms  TICSp02ms  TICSp04ms  TICSp06ms  TICSp08ms  TICSp10ms  TICSp12ms TICSp14ms TICSp16ms TICSp18ms /missing; run; /*values 0,7,8,13*/
proc freq data=directvars; tables tics2-tics14; run;/*as expected range 0-13*/
proc means data=directvars n min max mean; var tics2-tics14; run;
...
proc print data=directvars (obs=20); var R14SER7 R14BWC20new R14BWC20 R14CACT R14DY R14MO R14YR R14DW R14PRES R14VP TICSp18ms tics14; where tics14 ne .; run;
...
data cog.directvars (keep= R3IWSTAT R4IWSTAT R5IWSTAT R6IWSTAT R7IWSTAT R8IWSTAT R9IWSTAT R10IWSTAT R11IWSTAT R12IWSTAT R13IWSTAT R14IWSTAT
						   R2WTRESP R3WTRESP R4WTRESP R5WTRESP R6WTRESP R7WTRESP R8WTRESP R9WTRESP R10WTRESP R11WTRESP R12WTRESP R13WTRESP
						   R3PROXY  R4PROXY  R5PROXY  R6PROXY  R7PROXY  R8PROXY  R9PROXY  R10PROXY  R11PROXY R12PROXY R13PROXY	R14PROXY
						   R3IMRC   R4IMRC 	 R5IMRC   R6IMRC   R7IMRC   R8IMRC   R9IMRC   R10IMRC   R11IMRC  R12IMRC  R13IMRC	R14IMRC
						   R3FIMRC  R4FIMRC  R5FIMRC  R6FIMRC  R7FIMRC  R8FIMRC  R9FIMRC  R10FIMRC  R11FIMRC R12FIMRC R13FIMRC	R14FIMRC
						   R3DLRC   R4DLRC   R5DLRC   R6DLRC   R7DLRC   R8DLRC   R9DLRC   R10DLRC   R11DLRC  R12DLRC  R13DLRC	R14DLRC
						   R3FDLRC  R4FDLRC  R5FDLRC  R6FDLRC  R7FDLRC  R8FDLRC  R9FDLRC  R10FDLRC  R11FDLRC R12FDLRC R13FDLRC	R14FDLRC
						   tics3    tics4    tics5    tics6    tics7    tics8    tics9    tics10    tics11   tics12 tics13 tics14 HHIDPN HACOHORT RACOHBYR);
	merge directvars cog.randvars; by hhidpn;
proc sort; by hhidpn; run;
/*42234 observations and 99 variables.*/
...
%merge2sets(cog.fatvars, fat.h18e1a,               hhidpn  QD501 QD506-QD508 QD509-QD511 QD512-QD514 QD515-QD517 QD518-QD520 QD521-QD523 QD524-QD526 QD527-QD529 QD530-QD532 QD533-QD535 QD536-QD538 QD539-QD541 QD542-QD544 QD545-QD547 QD548-QD550 QD551-QD553,  
                                       fat.h16f2b, hhidpn  PD501 PD506-PD508 PD509-PD511 PD512-PD514 PD515-PD517 PD518-PD520 PD521-PD523 PD524-PD526 PD527-PD529 PD530-PD532 PD533-PD535 PD536-PD538 PD539-PD541 PD542-PD544 PD545-PD547 PD548-PD550 PD551-PD553, hhidpn,  ); 
...
%merge2sets(cog.fatvars, cog.fatvars, ,fat.hd10f5f, hhidpn MD501 MD506-MD508 MD509-MD511 MD512-MD514 MD515-MD517 MD518-MD520 MD521-MD523 MD524-MD526 MD527-MD529 MD530-MD532 MD533-MD535 MD536-MD538 MD539-MD541 MD542-MD544 MD545-MD547 MD548-MD550 MD551-MD553, hhidpn,  ); 
...
%merge2sets(cog.fatvars, cog.fatvars, ,cog.directvars,hhidpn R3IWSTAT R4IWSTAT R5IWSTAT R6IWSTAT R7IWSTAT R8IWSTAT R9IWSTAT R10IWSTAT R11IWSTAT R12IWSTAT R13IWSTAT R14IWSTAT R3PROXY  R4PROXY  R5PROXY  R6PROXY  R7PROXY  R8PROXY  R9PROXY  R10PROXY  R11PROXY R12PROXY R13PROXY R14PROXY, hhidpn,  ); 
/* 42,234 observations and 662 variables. */

/*Derive IQCODE variable by wave 1995-2018 */
...
/* 42,234 observations and 662+3=665 variables. */
...
/* 42,234 observations and 665+3=668 variables. */
...
/* 42,234 observations and 668+3=671 variables. */
...
/* 42,234 observations and 671+3=674 variables. */
...
/* 42,234 observations and 674+3=677 variables. */
...
/* 42,234 observations and 677+3=680 variables. */
...
/* 42,234 observations and 680+3=683 variables. */
...
/* 42,234 observations and 683+3=686 variables. */
...
/* 42,234 observations and 686+3=689 variables. */
...
/* 42,234 observations and 689+3=692 variables. */
...
/* 42,234 observations and 692+3=695 variables. */
...
/* 42,234 observations and 695+3=698 variables. */
...
/* 42,234 observations and 698+3=701 variables. */
...
proc freq data=proxyvars; tables  R3PROXY  R4PROXY  R5PROXY  R6PROXY  R7PROXY  R8PROXY  R9PROXY  R10PROXY  R11PROXY R12PROXY R13PROXY R14PROXY; run;
...
data cog.proxyvars (keep=hhidpn 
                      memrate95 memrate96  memrate98	memrate00	memrate02	memrate04	memrate06	memrate08	memrate10	memrate12 memrate14 memrate16 memrate18
                      IQCode95 	IQCode96   IQCode98    	IQCode00    IQCode02    IQCode04    IQCode06    IQCode08    IQCode10    IQCode12  IQCode14  IQCode16  IQCode18);
	set proxyvars;
	array mem[13] 	 E1056     D1056 		F1373 		G1527 		HD501 		JD501 		KD501 		LD501 		MD501 		ND501 		OD501		PD501	  QD501	;
	array newmem[13] memrate96 memrate95    memrate98	memrate00	memrate02	memrate04	memrate06	memrate08	memrate10	memrate12 	memrate14	memrate16 memrate18;
	do i=1 to 13;
...
proc sort; by hhidpn; run;
/* 42,234 observations and 27 variables */

/*QC*/
proc freq data=cog.proxyvars; tables memrate95 memrate96  memrate98	memrate00	memrate02	memrate04	memrate06	memrate08	memrate10	memrate12 memrate14 memrate16 memrate18 /missing; run;
proc freq data=cog.proxyvars; tables memrate95 memrate96  memrate98	memrate00	memrate02	memrate04	memrate06	memrate08	memrate10	memrate12 memrate14 memrate16 memrate18; run;
proc means data=cog.proxyvars; var IQCode95 	IQCode96   IQCode98    	IQCode00    IQCode02    IQCode04    IQCode06    IQCode08    IQCode10    IQCode12 IQCode14 IQCode16 IQCode18; run;

/*Get demographic variables: Male, Age, and Black from tracker*/
data trk2018; 
  set trk.trk2018tr_r (keep=hhid pn race hispanic gender STUDY BIRTHYR
                          AAGE BAGE CAGE DAGE EAGE FAGE GAGE HAGE JAGE KAGE LAGE MAGE NAGE OAGE PAGE QAGE QWGTR );
  HHIDPN=HHID*1000 + PN;
proc sort; by hhidpn; run;
/* 43,398 observations and 25 variables. */


/*Get new variables age3-age11 depending on HRS cohort. Get new variables for gender and race*/
data cog.trk (drop= AAGE BAGE CAGE DAGE EAGE FAGE GAGE HAGE JAGE KAGE LAGE MAGE NAGE OAGE PAGE QAGE gender race hispanic);
	set trk2018;
	array  age[11]    FAGE GAGE HAGE JAGE KAGE  LAGE MAGE  NAGE	 OAGE	PAGE  QAGE;
  	array  agenew[11] age4 age5 age6 age7 age8  age9 age10 age11 age12	age13 age14;
...
proc sort; by hhidpn; run;
/*43,398 observations and 25-19+12+3=21 variables.*/

/*QC*/
proc means data=cog.trk; var  age3 age4 age5 age6 age7 age8 age9 age10 age11 age12 age13 age14;  run;	 
...
data all;
	...
	array mem[11]    memrate98	memrate00	memrate02	memrate04	memrate06	memrate08	memrate10	memrate12 	memrate14	memrate16	memrate18;
	array newmem[11] memrate_4	memrate_5	memrate_6	memrate_7	memrate_8	memrate_9	memrate_10	memrate_11	memrate_12	memrate_13	memrate_14;

	array iq[11]     IQCode98    IQCode00    IQCode02    IQCode04    IQCode06    IQCode08    IQCode10    IQCode12	IQCode14	IQCode16	IQCode18;
	array newiq[11]  AVGIQ_4     AVGIQ_5     AVGIQ_6     AVGIQ_7   	 AVGIQ_8     AVGIQ_9     AVGIQ_10    AVGIQ_11	AVGIQ_12	AVGIQ_13	AVGIQ_14;
    do i=1 to 11;
		newmem[i]=mem[i];
		newiq[i]=iq[i];
	end; drop i;
	...
	array wordis[12]     	R3IMRC 		R4IMRC 	  	R5IMRC 		R6IMRC 	 	R7IMRC   	R8IMRC   	R9IMRC   	R10IMRC   		R11IMRC			R12IMRC		R13IMRC		R14IMRC;
	array wordi_cs[12]   	wordi_c3    wordi_c4    wordi_c5    wordi_c6    wordi_c7    wordi_c8    wordi_c9    wordi_c10   	wordi_c11		wordi_c12	wordi_c13	wordi_c14;
	array wordds[12]     	R3DLRC 		R4DLRC 	  	R5DLRC 		R6DLRC   	R7DLRC   	R8DLRC   	R9DLRC   	R10DLRC   		R11DLRC			R12DLRC		R13DLRC		R14DLRC;
	array wordd_cs[12]   	wordd_c3    wordd_c4    wordd_c5    wordd_c6    wordd_c7    wordd_c8    wordd_c9    wordd_c10   	wordd_c11		wordd_c12	wordd_c13	wordd_c14;
	array iqcodels[12]   	AVGIQ_3    	AVGIQ_4     AVGIQ_5     AVGIQ_6     AVGIQ_7   	AVGIQ_8     AVGIQ_9     AVGIQ_10    	AVGIQ_11		AVGIQ_12	AVGIQ_13	AVGIQ_14;
	array iqcode_cls[12] 	iqcode_c3   iqcode_c4   iqcode_c5   iqcode_c6   iqcode_c7   iqcode_c8   iqcode_c9   iqcode_c10  	iqcode_c11		iqcode_c12	iqcode_c13	iqcode_c14;
	array prxmemls[12]   	memrate_3	memrate_4	memrate_5	memrate_6   memrate_7   memrate_8	memrate_9	memrate_10		memrate_11		memrate_12	memrate_13	memrate_14;
	array prxmem_cls[12] 	prxmem_c3   prxmem_c4   prxmem_c5   prxmem_c6   prxmem_c7   prxmem_c8   prxmem_c9   prxmem_c10 		prxmem_c11		prxmem_c12	prxmem_c13	prxmem_c14;
	array ticss[12]   	  	tics3 		tics4     	tics5  		tics6  	 	tics7    	tics8    	tics9    	tics10    		tics11			tics12		tics13		tics14;
	array tics_cs[12]   	tics_c3     tics_c4     tics_c5     tics_c6     tics_c7     tics_c8     tics_c9     tics_c10    	tics_c11		tics_c12	tics_c13	tics_c14;
	array memimpls[12]  	memimp3     memimp4     memimp5     memimp6     memimp7     memimp8     memimp9     memimp10    	memimp11		memimp12	memimp13	memimp14;
	array dementpimpls[12] 	dementpimp3 dementpimp4 dementpimp5 dementpimp6 dementpimp7 dementpimp8 dementpimp9 dementpimp10 	dementpimp11	dementpimp12 dementpimp13	dementpimp14;

	array alives [12]      	R3IWSTAT 	R4IWSTAT 	R5IWSTAT 	R6IWSTAT 	R7IWSTAT 	R8IWSTAT 	R9IWSTAT 	R10IWSTAT 	R11IWSTAT	R12IWSTAT 	R13IWSTAT	R14IWSTAT;
	array iwtypes [12]  	R3PROXY  	R4PROXY  	R5PROXY  	R6PROXY  	R7PROXY  	R8PROXY  	R9PROXY  	R10PROXY  	R11PROXY	R12PROXY	R13PROXY	R14PROXY;
	array agels [12]    	age3		age4 		age5 		age6 		age7 		age8 		age9 		age10 		age11		age12		age13		age14;
...
run;
proc sort; by hhidpn; run;
/* 42,234 observations and 281 variables */

data cog.cogvars_gdr_20220522 (drop=memrate95 memrate96  memrate98	memrate00	memrate02	memrate04	memrate06	memrate08	memrate10	memrate12 memrate14 memrate16 memrate18
                    				IQCode95  IQCode96 	 IQCode98   IQCode00   	IQCode02    IQCode04    IQCode06    IQCode08    IQCode10    IQCode12 IQCode14 IQCode16 IQCode18
									age_c dpeligible dpimp etemp iqcode iqcode_c iqcode_c3-iqcode_c14 iqcodefor iqcodelag
									memeligible memimp proxy prxmem prxmem_c prxmem_c3-prxmem_c14 prxmemfor prxmemlag scorems
									tics_c3-tics_c14 ticscore ticscore_c ticscorefor ticscorelag
									wordd_c3-wordd_c14 wordi_c3-wordi_c14 wordscored wordscored_c wordscoredfor wordscoredlag 
...
;
proc sort; by hhidpn; run;
/* 42,234 observations and 167 variables. */

/**************************************************************************************************************************************************************************************************************************/

ods csv file='path\DataDictionary_gdr_20220522.csv';
proc contents data=cog.cogvars_gdr_20220522; run;
ods csv close;

/*Export dataset above to Stata*/
PROC EXPORT DATA= cog.cogvars_gdr_20220522
            OUTFILE= "path\cogvars_gdr_20220522.dta" 
            DBMS=STATA REPLACE;
RUN;
/*The export data set has 42,234 observations and 167 variables*/

/*Create reduced dataset: dataset with only hhidpn, dementia probabilities, and composite memory scores from orginal cogvars_gdr_20220522 dataset*/
data cog.cogvarsred_gdr_20220522;
	set cog.cogvars_gdr_20220522 (keep=hhidpn dementpimp3-dementpimp14 memimp3-memimp14);
proc sort; by hhidpn; run;
proc contents data=cog.cogvarsred_gdr_20220522; run;
/* 42,053 observations and 23 variables */

/*Export dataset above to Stata*/
PROC EXPORT DATA= cog.cogvarsred_gdr_20220522
            OUTFILE= "path\cogvarsred_gdr_20220522.dta" 
            DBMS=STATA REPLACE;
RUN;
/*The export data set has 42,234 observations and 25 variables */
